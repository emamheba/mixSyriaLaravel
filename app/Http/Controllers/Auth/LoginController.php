...
class LoginController extends Controller
{
    ...
    */
    ...
    public function adminLogin(Request $request)
    {
        ...
        return redirect()->back()->withErrors('Your or Password Is Wrong');
    ...
    public function userLogin(Request $request)
    {
            ...
            if (Auth::guard('web')->attempt([$email_or_username => $request->email, 'password' => $request->password],$request->get('remember'))){
                ...
                if (!empty($user_account_status) && $user_account_status->status === 1){
                    ...
                    return redirect()->back()->withErrors('Your account has been deleted');
                }else{
                    if(Auth::user()){
