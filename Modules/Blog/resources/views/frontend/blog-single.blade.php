            ...
            <div class="row g-4">
                <div class="col-lg-8">
                    ...
                    @if($blog_post->comments?->count() > 0)
                        ...
                        <button id="loadMoreCommentsBtn" class="new-cmn-btn browse-ads  mt-5 new_load_more_comments">
                            {{ get_static_option('blog_comment_load_more_title') ?? __('Load More Comments') }}
                        </button>
                    @endif
                </div>
                <div class="col-lg-4">
