...
//admin routes
Route::group(['as'=>'admin.','prefix'=>'admin/support-ticket','middleware' => ['auth:admin']],function() {
    //department
...
//users routes
Route::group(['prefix'=>'user/support-ticket','as'=>'user.','middleware'=>['auth','userEmailVerify','globalVariable', 'maintains_mode']],function() {
