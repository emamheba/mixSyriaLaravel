    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            $(document).on('click','.deposit_amount_to_wallet',function(e){
                ...
                let max_amount = parseInt("{{ get_static_option('deposit_amount_limitation_for_user') ?? '5000' }}");
            ...
            function histories(page){
                $.ajax({
                    url:"{{ route('user.wallet.paginate.data').'?page='}}" + page,
