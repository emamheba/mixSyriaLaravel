...
@section('site-title')
    {{__('User Membership Active Email Template')}}
@endsection
@section('style')
    <x-media.css/>
    <x-summernote.css/>
            ...
            <div class="dashboard__card bg__white padding-20 radius-10">
                <div class="dashboard_orderDetails__header__flex">
                    <div class="dashboard_orderDetails__header__left">
                         <h2 class="dashboard__card__header__title mb-3">{{__('User Membership Active Template')}}</h2>
                    </div>
                ...
                <form action="{{route('admin.email.user.membership.active.template')}}" method="POST">
                    ...
                    <div class="form__input__single">
                        <label for="user_membership_active_email_subject" class="form__input__single__label">{{__('Email Subject')}}</label>
                    ...
                    <div class="form__input__single">
                        ...
                        <textarea class="form__control summernote" name="user_membership_active_message">{!! get_static_option('user_membership_active_message') ?? 'Your membership status changed from inactive to active. Membership ID: @membership_id'  !!} </textarea>
                    </div>
                    <div class="d-grid">
