...
class IntegrationsController extends Controller
{
    public function store(Request $request)
    {
        if($request->isMethod('post')){
            ...
            match ($request->data_type){
                ...
                "google_captcha_v2" => $this->google_captcha_v2(),
    ...
    private function google_captcha_v2()
    {
        $req = \request();

        update_static_option('recaptcha_2_site_key',$req->recaptcha_2_site_key);
        update_static_option('recaptcha_2_secret_key',$req->recaptcha_2_secret_key);
    }
