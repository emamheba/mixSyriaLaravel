...
@section('title', 'Category Add - Apps')
...
<div class="app-ecommerce">
  ...
  <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
    <div class="d-flex flex-column justify-content-center">
      <h4 class="mb-1">{{__('Add new Category')}}</h4>
    ...
    <div class="col-xl mb-6">
      <div class="card">
        ...
        <div class="card-body">
          <form action="{{route('categories.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
              ...
              <input type="text" class="form-control" id="basic-default-fullname" name="name" placeholder="{{__('category name')}}">
            </div>
        ...
        <select id="category-type" class="form-select" name="category_type">
            ...
            <option value="sell">{{ __('بيع') }}</option>
            <option value="rent">{{ __('إيجار') }}</option>
            <option value="job">{{ __('وظيفة') }}</option>
