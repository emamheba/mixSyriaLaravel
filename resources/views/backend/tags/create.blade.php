            ...
            <div class="col-xl mb-6">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">{{ __('Create Tag') }}</h5>
                    ...
                    <div class="card-body">
                        <form action="{{ route('tags.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" class="form-control" id="basic-default-fullname" name="name" placeholder="{{ __('Tag name') }}">
                            </div>
